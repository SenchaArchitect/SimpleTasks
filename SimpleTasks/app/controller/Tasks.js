...
Ext.define('SimpleTasks.controller.Tasks', {
    ...
    handleSpecialKey: function(field, e, eOpts) {
         if(e.getKey() === e.ENTER) {
                    this.newTask();
                }
    },
    ...
    handleDeleteClick: function(button, e, eOpts) {
                this.deleteTask(this.getTaskGrid().getSelectionModel().getSelection()[0]);

    },

    handleDeleteTaskItemClick: function(button, e, eOpts) {
        this.handleDeleteClick(button, e, eOpts);
    },

    markComplete: function(button, e, eOpts) {
    ...
    markCompleteButton: function(button, e, eOpts) {
        this.markComplete(button, e, eOpts);
    },

    markActive: function(button, e, eOpts) {
            var contextMenu = this.getContextMenu(),
                    task = contextMenu.isVisible() ? contextMenu.getTask() : this.getTaskGrid().getSelectionModel().getSelection()[0];
    ...
    markActiveButton: function(button, e, eOpts) {
        this.markActive(button, e, eOpts);
    },

    filterAll: function(button, e, eOpts) {
    ...
    filterActive: function(button, e, eOpts) {
        var tasksStore = this.getTasksStore(),
                    filters = tasksStore.filters.getRange(0, tasksStore.filters.getCount() - 1),
                    filterCount = filters.length,
                    i = 0;
    ...
    filterComplete: function(button, e, eOpts) {
           var tasksStore = this.getTasksStore(),
                    filters = tasksStore.filters.getRange(0, tasksStore.filters.getCount() - 1),
                    filterCount = filters.length,
                    i = 0;
    ...
    handleEditItemClick: function(button, e, eOpts) {
    ...
    handleDeleteIconClick: function(gridView, rowIndex, colIndex, column, e) {
    ...
    toggleReminderFields: function(field, newValue, oldValue, eOpts) {
         var checkbox = field,
    ...
    hideEditWindow: function(button, e, eOpts) {
          this.getTaskEditWindow().close();
    },

    handleSaveTaskClick: function(button, e, eOpts) {
         this.saveEditWindow();
    },
    ...
    toggleCompleteField: function(button, e, eOpts) {
    ...
    deleteTaskAndCloseEditWindow: function(button, e, eOpts) {
            var me = this,
    ...
    hideDefaultTimeWindow: function(button, e, eOpts) {
           this.getDefaultTimeWindow().close();
    },

    saveDefaultTime: function(button, e, eOpts) {
          var me = this,
                    defaultTimeWindow = me.getDefaultTimeWindow(),
    ...
    snooze: function(button, e, eOpts) {
    ...
    dismissReminder: function(button, e, eOpts) {
